...
class Migrate_1 extends Base
{
    public static function getDBCfg() : array
    {
        $dbJson = file_get_contents(APP_ROOT . '/config/migrate/migrate_1_db.json');
    ...
    {
        $sqlJson = file_get_contents(APP_ROOT . '/config/migrate/migrate_1_sql.json');
    ...
    public function migrate() : void
    {
        ...
        try {
            ...
            Vari::get()->setVari('system', ['data_version' => 1 + 1]);
            $this->driver->commit();
        } catch (Exception $ex) {
